  ...
  return (
    ...
    >
      <Link href={`/meals/${item.idMeal}`}>
        ...
        />
        <div className="dark from-background text-foreground group-hover:text-primary-foreground group-hover:from-primary pointer-events-none absolute inset-0 top-auto bottom-0 left-0 flex h-40 flex-col justify-end bg-linear-to-t p-3 transition-colors">
